...
protected:
  ...
  void trivialSpillEverywhere(LiveRangeEdit& LRE) {
    ...
    for (MachineRegisterInfo::reg_iterator
      ...
      MachineInstr *mi = &*regItr;                            // operator* return an MachineInstr
      ...
      do {
        ++regItr;
      } while (regItr != mri->reg_end() && (&*regItr == mi)); // If it is still in the same instruction (&*regItr == mi), fast forward.
